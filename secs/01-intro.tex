...
The problem of relative localization between a quadrotor and
a moving target is more challenging. In \cite{tobiuwb}, a quadrotor
outfitted with four UWBs was able to follow a person carrying a UWB tag
with 10 cm mean error. Building upon that work we employ six UWB sensors on a car to localize a UWB on the quadrotor with an
