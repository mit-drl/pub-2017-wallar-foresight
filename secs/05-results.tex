...
landed back on the car's platform.  In every case, take off, path following,
and landing was successfully completed. For the remainder of this section we
will detail one representative experiment.
