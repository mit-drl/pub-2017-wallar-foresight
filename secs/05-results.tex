...
\begin{figure}[t!]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \centering
        \includegraphics[width=1.0\linewidth]{exp-car-landing}
        \caption{}
...
autonomous golf cart. Figure (d) shows one of the environments in which we
tested landing.}
...
In the course of one afternoon we performed 25 tests in the environment shown in
Fig.~\ref{fig:exp-car-garage} in which the quadrotor 
successfully took off from
the car, followed a path to detect blind spots, and landed back on the car's platform.
In every case, take off, path following, and landing worked without error. For the
remainder of this section we will detail one representative experiment.

In addition, over 10 tests
